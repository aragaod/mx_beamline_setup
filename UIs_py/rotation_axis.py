...
class Ui_RemoteAccess_WZ(object):
    def setupUi(self, RemoteAccess_WZ, width=800, height=500):
        ...
        self.WP1_Label_1.setGeometry(QtCore.QRect(10, 10, width - 10, height - 20))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.WP1_Label_1.setFont(font)
        self.WP1_Label_1.setWordWrap(True)
        self.WP1_Label_1.setTextInteractionFlags(
        ...
        self.WP2_Label_1.setTextInteractionFlags(
            QtCore.Qt.LinksAccessibleByMouse
            | QtCore.Qt.TextSelectableByKeyboard
            | QtCore.Qt.TextSelectableByMouse
        )
    ...
    def retranslateUi(self, RemoteAccess_WZ):
        ...
        self.WP1_Label_1.setText(
            _translate(
                "RemoteAccess_WZ",
                "If you have remote users today you should do the NX texts next. \n"
        ...
        self.WP2_Label_1.setText(
            _translate(
                "RemoteAccess_WZ",
                "Check if there are any old java processes from NX sessions that have not been properly closed and are not part of a current visit.\n"
                "\n"
